...
const Home = ({ paletteName }) => {
  ...
  const cards = [
    ...
    { id: 2, frontText: 'Front Side 2', backText: 'Back Side 2', frontBackgroundColor: palette.content1, backBackgroundColor: palette.main },
    { id: 3, frontText: 'Front Side 3', backText: 'Back Side 3', frontBackgroundColor: palette.content2, backBackgroundColor: palette.main },
  ];
